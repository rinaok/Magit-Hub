...
@WebServlet(name = "SendMessagesServlet", urlPatterns = {"/pages/users/getMessages"})
public class SendMessagesServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        MagitMsgManager magitMsgManager = ServletUtils.getMsgManager(getServletContext());
        String timestamp = Utils.getTime();
        String messageString = request.getParameter(Constants.GIT_PARAMETER);
