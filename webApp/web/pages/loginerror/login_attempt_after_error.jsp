<%--
    ...
    Author     : blecherl
    This is the login JSP for the online client.server application
--%>

<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
    <%@page import="client.server.utils.*" %>
    <%@ page import="client.server.constants.Constants" %>
    <head>
...
<!--        and\or any other scripts you might need to operate the JSP file behind the scene once it arrives to the client-->
    ...
    <body>
        <div class="container">
            ...
            <a href="../users/user.html">Click here to enter the client.server room</a>
            <br/>
